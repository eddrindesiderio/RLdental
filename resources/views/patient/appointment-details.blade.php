...
<body class="hold-transition sidebar-mini">
  ...
  <script>
    ...
    function confirmAppointment() {
      ...
      const appointmentSessionId = "{{ $appointment->id }}";
        ...
        if (result.isConfirmed) {
          $.ajax({
            ...
            success: function(response) {
              if (response.success) {
                Swal.fire('Booked!', 'Your appointment has been booked successfully.', 'success')
                  .then(() => window.location.href = "{{ route('patient.appointment') }}");
              } else {
