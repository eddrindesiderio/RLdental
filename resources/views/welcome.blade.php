...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
                    ...
                    <div class="col-md-4 col-sm-6 mb-4">
                        <div class="card text-center">
                            ...
                            <div>
                                ...
                                <p>At Easy Appointment Dental Clinic, we make scheduling effortless, while RL Tenorio Talicuran Dental Clinic ensures exceptional dental care with a focus on your comfort and well-being.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 mb-4">
                        <div class="card text-center">
                            ...
                            <div>
                                ...
                                <p>At Easy Appointment Dental Clinic, we offer convenient scheduling and Emergency Services at RL Tenorio Talicuran Dental Clinic, ensuring quick and reliable care when you need it most.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 mb-4">
                        <div class="card text-center">
                            ...
                            <div>
                                <h4>24/7 Service</h4>
                                <p>At Easy Appointment Dental Clinic, we offer convenient scheduling and 24/7 Emergency Services at RL Tenorio Talicuran Dental Clinic, ensuring quick and reliable care whenever you need it.</p>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  <script>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-start">
                    ...
                    <p>Welcome to a family at RL Tenorio Talicuran Dental Clinic, where we offer emergency services and compassionate care tailored to your needs, whenever you need us.</p>
                    <div class="mt-5 card">
    ...
    <div class="container">
        ...
        <div class="row"> <!-- Added this row to properly group the two dentists -->
            <div class="col-md-6 col-sm-12 mb-4"> <!-- Changed col-md-4 to col-md-6 to fit two items side by side -->
                <div class="card rounded-3">
                    <div class="team-img">
                        <img decoding="async" src="{{asset('images/team/57.jpg')}}" class="img-fluid">
                    </div>
                    <div class="team-info pt-4 text-center">
                        <h5>Dr. Ryan Tenorio Talicuran</h5>
                        <p>DMD</p>
                        <ul class="social-network">
                        <li><a href="https://www.facebook.com/ladylyn.balisitlcrn" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="mailto:rltenoriotalicurandental@gmail.com" target="_blank"><i class="fab fa-google-plus-g"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>

            <div class="col-md-6 col-sm-12 mb-4"> <!-- Same change here -->
                <div class="card rounded-3">
                    <div class="team-img">
                        <img decoding="async" src="{{asset('images/team/66.jpg')}}" class="img-fluid">
                    </div>
                    <div class="team-info pt-4 text-center">
                        <h5>Dr. Lady Lyn Balisa Talicuran</h5>
                        <p>DMD</p>
                        <ul class="social-network">
                        <li><a href="https://www.facebook.com/ladylyn.balisitlcrn" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="mailto:rltenoriotalicurandental@gmail.com" target="_blank"><i class="fab fa-google-plus-g"></i></a></li>
    ...
    <section id="gallery" class="gallery_wrapper wrapper">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <img decoding="async" src="{{asset('images/gallery/21321.png')}}" class="w-100 h-100">
                </div>
                <div class="col-md-4 col-sm-6 mb-4">
                    <img decoding="async" src="{{asset('images/gallery/3324.png')}}" class="w-100 h-100">
                </div>
                <div class="col-md-4 col-sm-6 mb-4">
                    <img decoding="async" src="{{asset('images/gallery/44123.png')}}" class="w-100 h-100">
                </div>
                <div class="col-md-8 col-sm-6 mb-4">
                    <img decoding="async" src="{{asset('images/gallery/612.png')}}" class="w-100 h-100">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-xl-3 col-md-4 col-sm-6">
                    <div class="card text-center">
                        <img decoding="async" src="{{asset('images/testimonial/61232.png')}}" class="img-fluid">
                        <h4 class="pt-4 mb-0">RL Tenorio Talicuran Dental Clinic</h4>
                        <p>Dr. Ryan and Dr. Lady Lyn</p> 
                    </div>
                </div>
                <div class="col-xl-9 col-md-8 col-sm-6 ps-md-4 pt-sm-0 pt-4">
                    <h4>Awesome Experience!</h4>
                    <p>“The team truly took my dental concerns to heart. Everyone was incredibly helpful, and it was clear they worked seamlessly together to ensure my comfort. Thanks to their care, I walked out with a healthy smile and pain-free. Highly recommend!”</p>
                </div>
            </div>
        </div>
    </section> 
    ...
    <section id="blog" class="blog_wrapper wrapper">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="card p-0 border-0 rounded-0">
                        ...
                        <div class="blog-content">
                            <h5 class="text-white mb-4">A Beautifull Smile Restored</h5>
                            <h6 class="text-white">By RL Tenorio Talicuran Dental Clinic - November 30, 2024</h6>
                            <p class="mt-2 text-white">At RL Dental, we believe every smile has a story, and Tita Teodora’s journey is one we’re proud to be part of.
                            </p>
                            <a href="https://www.facebook.com/photo?fbid=871646291836328&set=a.379710884363207" class="main-btn mt-2" target="_blank">Read More</a>
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="card p-0 border-0 rounded-0">
                        <img decoding="async" src="{{asset('images/blog/222.jpg')}}">
                        <div class="blog-content">
                            <h5 class="text-white mb-4">Big Smiles And Happy</h5>
                            <h6 class="text-white">By RL Tenorio Talicuran Dental Clinic - November 29, 2024</h6>
                            <p class="mt-2 text-white">Rupert Nicholas came in for his ART Fluoride-releasing filling and was an absolute star throughout the process.
                            </p>
                            <a href="https://www.facebook.com/photo?fbid=871014001899557&set=a.379710884363207" class="main-btn mt-2" target="_blank">Read More</a>
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="card p-0 border-0 rounded-0">
                        <img decoding="async" src="{{asset('images/blog/333.jpg')}}">
                        <div class="blog-content">
                            <h5 class="text-white mb-4">Braces</h5>
                            <h6 class="text-white">By RL Tenorio Talicuran Dental Clinic - November 28, 2024</h6>
                            <p class="mt-2 text-white">ʙʀᴀᴄᴇs: More than Meets the Eye! Beyond straightening teeth, they help boost confidence and transform smiles. 
                            </p>
                            <a href="https://www.facebook.com/photo?fbid=870354241965533&set=a.379710884363207" class="main-btn mt-2" target="_blank">Read More</a>
...
<section id="contact" class="footer_wrapper wrapper">
    ...
    <!-- Google Maps link -->
    <li>
        <a href="https://www.google.com/maps/search/?api=1&query=adis+street+171+Tapia+Subdivision,+Poblacion+6,+tanauan+city+batangas" target="_blank">
            <i class="fa fa-home me-3"></i> adis street 171 Tapia Subdivision, Poblacion 6, tanauan city batangas
        </a>
    </li>
    <!-- Phone link -->
    <li>
        <a href="tel:+639176256476">
            <i class="fa fa-phone me-3"></i> +639176256476
        </a>
    </li>
    <!-- Email link -->
    <li>
        <a href="mailto:rltenoriotalicurandental@gmail.com">
            <i class="fa fa-envelope me-3"></i> rltenoriotalicurandental@gmail.com
        </a>
    </li>
</ul>
                ...
                <ul class="social-network d-flex justify-content-center align-items-center p-0">
                    <li><a href="https://www.facebook.com/RLTenorioTalicuranDentalClinic" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                    <li><a href="mailto:rltenoriotalicurandental@gmail.com" target="_blank"><i class="fab fa-google-plus-g"></i></a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="container-fluid copyright-section">
            <p class="p-0">Copyright <a href="#">© RL </a> All Rights Reserved</p>
        </div>
    </section>
